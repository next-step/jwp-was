...
class ResourceViewResolverTest {
    ...
    void uri에_슬래시만_입력해도_index_html로_설정() throws IOException, URISyntaxException {
        ...
        // then
        assertThat(resourceViewResolver.getPath()).isEqualTo("/index.html");
    }
    ...
    void uri가_슬래시로_시작하지_않으면_슬래시를_붙여준다() throws IOException, URISyntaxException {
        // given
        // when
        ResourceViewResolver resourceViewResolver = new ResourceViewResolver("index.html");
    ...
    void 확장자를_생략하면_html을_붙여준다() throws IOException, URISyntaxException {
        // given
        // when
        ResourceViewResolver resourceViewResolver = new ResourceViewResolver("index");
