...
class QueryStringTest {
    ...
    void test1(String input) {
        final Parameters queryString = new Parameters(input);
    ...
    void test2() {
        ...
        final String idValue = queryString.getValue("id");
        final String contentValue = queryString.getValue("content");
    ...
    void test5() {
        ...
        final String result = queryString.getValue("id");
