...
class RequestParametersTest {
    ...
    void test_parse_same_queryString() {
        ...
        Assertions.assertThat(parameters.getOne("password")).isEqualTo("password");
        ...
        Assertions.assertThat(parameters.getOne("userId")).isNull();
    }
    ...
    private void checkParameter(String actual, String value) {
