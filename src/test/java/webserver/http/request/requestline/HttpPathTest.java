...
class HttpPathTest {
    ...
    void getFullPathWithQueryStrings() {
        ...
        assertThat(httpPath.getHttpQueryStrings().get(0)).isEqualTo(HttpRequestParam.from("queryName=queryValue"));
        assertThat(httpPath.getHttpQueryStrings().get(1)).isEqualTo(HttpRequestParam.from("queryName2=queryValue2"));
    ...
    void getFullPathWithQueryStrings_urlDecode() {
        ...
        assertThat(httpPath.getHttpQueryStrings().get(0)).isEqualTo(HttpRequestParam.from("userId=thxwelchs"));
        assertThat(httpPath.getHttpQueryStrings().get(1)).isEqualTo(HttpRequestParam.from("password=password"));
        assertThat(httpPath.getHttpQueryStrings().get(2)).isEqualTo(HttpRequestParam.from("name=이태훈"));
        assertThat(httpPath.getHttpQueryStrings().get(3)).isEqualTo(HttpRequestParam.from("email=thxwelchs@gmail.com"));
