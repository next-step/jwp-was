...
import static http.request.requestline.path.FileExtension.FilePrefix.DEFAULT_FILE_PREFIX;
import static http.request.requestline.path.FileExtension.FilePrefix.STATIC_FILE_PREFIX;
