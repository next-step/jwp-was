...
public class Router {
    ...
    private static final Map<String, BiFunction<HttpRequest, HttpResponse, Optional<Object>>> routerMap = new HashMap<>();
    static {
        routerMap.put(POST_METHOD + "/user/create", UserController::createUser);
        routerMap.put(POST_METHOD + "/user/login", UserController::login);
    }

    public static Optional<Object> route(HttpRequest httpRequest, HttpResponse httpResponse) {
