...
public class RegisterFormController<V extends ViewResolver> extends AbstractController<HttpRequest, HttpResponse> {

    private static final Logger logger = LoggerFactory.getLogger(RegisterFormController.class);

    private V viewResolver;

    public RegisterFormController(V viewResolver) {
